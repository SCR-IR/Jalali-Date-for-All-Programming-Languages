...
namespace Jdf {
  ...
  public class Program {
    ...
    public static void Main (string[] args) {
      ...
      int[] tarikh_j = DateConverter.gregorian_to_jalali (2020, 5, 17);
      int jy = tarikh_j[0];
      int jm = tarikh_j[1];
      int jd = tarikh_j[2];
      Console.WriteLine ("Jalali: \t" + jy + "/" + jm + "/" + jd);

      int[] tarikh_g = DateConverter.jalali_to_gregorian (1399, 2, 28);
      int gy = tarikh_g[0];
      int gm = tarikh_g[1];
      int gd = tarikh_g[2];
      Console.WriteLine ("Gregorian: \t" + gy + "/" + gm + "/" + gd);
